    ...
    override fun runTurn(userText: String): Flow<AgentEvent> = flow {
        ...
        turnMutex.withLock {
            ...
            val staleFocusCardId = session.conversationMemory.selectedContact
                ...
                ?.takeIf {
                    groundedReplacement ||
                        ((pendingNewTarget || (route as? TurnRoutePlan.Continue)?.namedTargetAcquisition == true) &&
                            turnTarget is TurnContactTargetResolver.Target.None)
                }
            ...
            val modelUserInput = ModelInput.User(
                    text = modelText,
